...
class RestaurantOrderManagement:
    def __init__(self,root):
        ...
        self.menu_items={"FRIES MEAL":2,"LUNCH MEAL":2,"BURGER MEAL":3,"PIZZA MEAL":4,"CHEESEBURGER":2.5,"DRINKS":1}
        ...
        currency_dropdown=ttk.Combobox(frame,textvariable=self.currency_var,state="readonly",width=18,value=('USD','INR'))
    ...
    def setup_background(self,root):
        ...
        canvas.pack()
        original_image=tk.PhotoImage(file="Dpower.png")
